...
def solve_part2(inputs: list):
    i = 0
    diag_code = input("please give input:")
    outputcodes = []
    instructs = {
...
if __name__ == "__main__":
    with open("/Users/hjjoosse/Documents/UMCU/Adventofcode/2019/inputs/input_d5") as f:
        content = f.read().split(",")
    print(solve_part1(content.copy()))
